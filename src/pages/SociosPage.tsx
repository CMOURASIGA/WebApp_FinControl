...
export const SociosPage: React.FC = () => {
  ...
  return <div className="space-y-6">
    <div className="flex items-center justify-between"><div><h1 className="text-2xl font-bold text-slate-900">Sócios</h1><p className="text-sm text-slate-500">Cadastro societário, participação e conta corrente.</p></div>{can('manage_partners') && <Button onClick={() => { setCriando(true); setSelecionado(''); }}>Novo sócio</Button>}</div>
